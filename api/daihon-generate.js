...
const PATTERN_LIST = `構文パターン11種:
1 ギャップ構文型「〇〇なのに〇〇」 / 2 結局これが一番型 / 3 騙されたと思って型 / 4 数字・スコア型 / 5 有名人権威型 / 6 ネガティブ→回収型 / 7 権威+意外性型 / 8 逆境サバイバル型 / 9 沼る・中毒性型 / 10 保証型 / 11 ギャップ裏切り型
...
注意: 「安い」を連呼するのではなく、"疑い"を作って"裏切る"設計にすること。ギャップの対象は価格に限らず(高そう/まずそう/地味そう/知らない店→実は…)応用可。`
